...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.buildAndRun = function (data) {
        ...
        //Content-Type declears the body type when you issue a POST
        var options = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/json' }) };
        return this.httpClient.post('api/v1/build_and_run', data, options)
            .toPromise() //convert ovservable to promise
            .then(function (res) {
            console.log(res);
            return res;
        })
...
module.exports = __webpack_require__(/*! /home/minliang/CS503-1805_minliang-lin/week3/oj-client/src/main.ts */"./src/main.ts");
